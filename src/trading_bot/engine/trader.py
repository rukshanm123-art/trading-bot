...
from trading_bot.market_data.validation import validate_candles
...
class TradingEngine:
    def __init__(
        ...
        self.portfolio = PortfolioService(self.repos, cfg.mode, self.rules)
    ...
    def run(self, max_cycles: int | None = None) -> None:
        ...
        try:
            ...
            sleep_s = min(60, max(5, self.cfg.interval_seconds // 60))
            cycles = 0
